...
trait BackendControllerHelper
{
    ...
    /**
     * full_page_ajax
     *  to make the create/update in modal in the same index page, with add small create form near table list
     * @var bool
     */
    ...
    /**
     * use_form_ajax
     * to make create/update form use ajax when make submit.
     * @var bool
     */
    ...
    public function throwException($error_message) :object
    {
        if ($this->full_page_ajax || ($this->use_form_ajax && $this->use_button_ajax))
            ...
            if ($this->use_form_ajax)
                ...
                return throw new Exception($error_message, 500);
        }
    }
}
